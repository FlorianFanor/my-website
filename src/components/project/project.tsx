    ...
    const githubProjects = [
        {
            ...
            description: "An interactive accessibility challenge that simulates color blindness and other visual impairments to raise awareness about inclusive web design.",
        ...
        },
        {
            ...
            description: "A full-stack platform enabling organizations to collaboratively manage and edit multilingual content for digital products.",
        ...
        },
        {
            ...
            description: "An AI-powered system for uploading, analyzing, and exploring time series data to automatically detect anomalies and understand patterns.",
        ...
        },
        {
            ...
            description: "A comprehensive tutorial project demonstrating React Hooks usage with practical task management functionality.",
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {githubProjects.filter(project => project.featured).map((project, index) => (
                            <div key={project.name} className="animate-fade-in-up" style={{ animationDelay: `${(index + 5) * 0.1}s` }}>
