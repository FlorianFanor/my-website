    ...
    <section id="resume" className="py-20 bg-gradient-to-b from-slate-50 to-blue-50">
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <h3 className="text-2xl md:text-3xl font-bold text-slate-700 mb-8">
          ...
          <div className="space-y-8 animate-fade-in-up">
            <div className="glass rounded-3xl p-8 bg-white/80 backdrop-blur-sm">
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                I'm a Technical Lead specializing in React, Next.js, Apollo GraphQL, JavaScript,
                HTML, and CSS, with a focus on building scalable, high-performance web applications.
                I have extensive experience in architecting front-end solutions, optimizing
                rendering performance, and integrating GraphQL APIs for efficient data handling.
              </p>
            </div>
            ...
            <div className="glass rounded-3xl p-8 bg-white/80 backdrop-blur-sm">
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                My background includes working with .NET, Python, and Angular, giving me a strong
                foundation in backend development, RESTful APIs, and full-stack architecture. I'm
                skilled in code optimization, design patterns, and modern development workflows,
                ensuring projects are both efficient and maintainable.
              </p>
            </div>
          </div>
        ...
        <div className="mt-20 animate-fade-in-up" style={{ animationDelay: "0.6s" }}>
          <div className="glass rounded-3xl p-8 bg-white/80 backdrop-blur-sm">
            ...
            <div className="space-y-6">
              <p className="text-lg text-slate-600 leading-relaxed">
                <strong className="text-slate-800">Accessibility</strong> is something I care deeply
                about because the web should be for everyone. Ensuring that digital experiences are
                usable by people of all abilities isn't just the right thing to do, it also leads to
                better, more inclusive design for all users.
              </p>

              <p className="text-lg text-slate-600 leading-relaxed">
                Many developers assume accessibility is complex, but in reality, it's approachable
                when you take it step by step. I've been expanding my knowledge with{" "}
                <a
                ...
                . This certification gave me a deeper understanding of WCAG principles, screen
                reader testing, keyboard navigation, and common design pitfalls.
              </p>
              ...
              <div className="gradient-secondary rounded-2xl p-6 border border-slate-200">
                ...
                <p className="text-slate-600 mb-4 leading-relaxed">
                  This interactive experience lets users test keyboard traps, inaccessible forms,
                  and visual impairments. It's designed to raise awareness by putting people in the
                  shoes of users with disabilities.
                </p>
                <a
        ...
        <div className="mt-16 animate-fade-in-up" style={{ animationDelay: "0.8s" }}>
          <div className="glass rounded-3xl p-8 bg-white/80 backdrop-blur-sm text-center">
            ...
            <p className="text-lg text-slate-600 leading-relaxed mb-8 max-w-4xl mx-auto">
              On a personal note, I enjoy sailing, playing ultimate frisbee, and volunteering at the
              Red Cross. Whether I'm out on the water, on the field, or helping out in the
              community, I love being in active and collaborative environments. These experiences
              keep me sharp, push me to adapt, and remind me of the value of teamwork, something I
              bring into my work as well.
            </p>
