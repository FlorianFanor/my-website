      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            My professional journey through different roles and technologies, building innovative
        ...
        <div className="relative">
          ...
          <div
            className="absolute hidden md:block left-6 md:left-1/2 transform md:-translate-x-1/2 w-1 bg-gradient-to-b from-blue-400 via-purple-500 to-blue-600 rounded-full opacity-30"
